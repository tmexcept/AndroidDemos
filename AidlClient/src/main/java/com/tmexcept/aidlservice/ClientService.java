...
public class ClientService extends Service {
    ...
    private final IBinder iBinder = new AidlInterface.Stub() {
...
//                wait(500);
        ...
        @Override
        public void minus(int num1, int num2) throws RemoteException {
...
//                wait(500);
        ...
        @Override
        public int minus2(int num1, int num2) throws RemoteException {
...
//            return num1 - num2;
        ...
        @Override
        public int testParam(int num1, int num2, int num3) throws RemoteException {
            Log.e(TAG, "aidl Service testParam "+num1+"   "+num2+"   "+num3);
            return 999;
        }

        @Override
        public int testParam2(int num1) throws RemoteException {
            return 0;
        }
    };
